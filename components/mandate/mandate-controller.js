...
ndpFramework.controller('MandateController',
    function($scope,
        $translate,
        $modal,
        $filter,
    ...
    $scope.model.horizontalMenus = [
        {id: 'target', title: 'targets', order: 1, view: 'components/mandate/results.html', active: true, class: 'main-horizontal-menu'}
    ];
    ...
    OptionComboService.getBtaDimensions().then(function( response ){
        ...
        console.log('response from MAN: ', response);

        $scope.model.selectedMenu = SelectedMenuService.getSelectedMenu();

        console.log('selected menu: ', $scope.model.selectedMenu);
        ...
        MetaDataFactory.getAll('categoryCombos').then(function(ccs){
            ...
            MetaDataFactory.getAll('dataElements').then(function(dataElements){
                ...
                MetaDataFactory.getDataElementGroups().then(function(dataElementGroups){
                    ...
                    MetaDataFactory.getAllByProperty('dataElementGroupSets', 'resultLevel', 'ati').then(function(dataElementGroupSets){

                        console.log('degs: ', dataElementGroupSets);
